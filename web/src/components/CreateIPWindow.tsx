...
export default function CreateIPWindow() {
    ...
    const handleRegisterAsset = async () => {
        ...
        try {
            ...
            const metadataHash = `0x${uploadedData.metadataHash.replace(/^0x/, "")}` as `0x${string}`;
    ...
    return (
        <StepLayout infoPanel={<InfoPanel title="Step 1: Asset Details" sections={infoSections} />}>
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold">Enter Asset Details</h3>
...
function RegisterAssetStep({
    ...
    return (
        <StepLayout infoPanel={<InfoPanel title="Step 2: Register Asset" sections={infoSections} />}>
            <div className="flex items-center justify-between mb-6">
